...
```
42 43 53 56 01 01 00 00 00 00 00 00 00 01 10 04 6E 61 6D 65 00 04 4A 6F 68 6E
```
...
[10] [04] [6E 61 6D 65]     # [type=str_8] [len=4] [value="name"]
[04] [4A 6F 68 6E]          # [len=4] [value="John"]
```
